...
title: "Day 06" 
date: '2022-04-06'
image: plots/day6_dcc_22.gif
categories:
  - R
  - Data Viz 
  - ggplot2
  - Data analysis
description: 'Day 6 from #30dataChartChallenge'
---

```{r}
knitr::include_graphics('plots/day6_dcc_22.gif')
```
...
data <- 'data/hdidx-corruption.csv' |> 
  read_csv()
data |> head()
```
