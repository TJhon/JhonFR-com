...
::: lead
Soy Jhon K. Flores Rojas, actualmente soy **Asistente de investigacón**, en [D2CML](https://d2cml-ai.github.io/d2cml.ai/) apoyando en temas **Causal Inference**, esto incluye creación de libros, modelos de machine learnign, visualización de datos, automatización y creacion de paquetes en diferentes lenguajes de programación.

Gracias a ello reforcé mis conocimientos de **Python**, **R**, **Julia**, **Stata**, **Linux** y **Github Workflow**. Tambien tengo conocimientos de otras herramientas de analisis de datos, como **PowerBI**, **SQL**.
:::
:::
